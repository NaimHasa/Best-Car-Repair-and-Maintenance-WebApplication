            ...
            <form onSubmit={handlePlaceOrder}>
                ...
                <div className='bg-slate-100 p-4 rounded-xl mt-5'>
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6 '>
                        <input type="text" name='fristName' placeholder="Frist Name" className="input input-bordered input-accent w-full " />
                        ...
                        <input type="text" name='email' placeholder="Email" defaultValue={user?.email} className="input input-bordered input-accent w-full " readOnly />
                    </div>
                    <textarea name='message' className="textarea textarea-bordered h-24 w-full mt-3 p-4" placeholder="Your Message"></textarea>
                    <input name='submit' type="submit" className='btn bg-slate-500 w-full  font-extrabold mt-4 ' value="Place Your Order" />
                </div>
            </form>
